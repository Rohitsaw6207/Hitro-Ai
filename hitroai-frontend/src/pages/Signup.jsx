...
const Signup = ({ setIsAuthenticated }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      {/* Multi-layered Animated Background - Same as other pages */}
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-r from-blue-400/20 to-purple-400/20 dark:from-blue-600/5 dark:to-purple-600/5 rounded-full blur-3xl animate-float-slow" />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-r from-purple-400/20 to-pink-400/20 dark:from-purple-600/5 dark:to-pink-600/5 rounded-full blur-3xl animate-float-reverse" />
        <div className="absolute top-1/2 right-1/3 w-64 h-64 bg-gradient-to-r from-cyan-400/15 to-blue-400/15 dark:from-cyan-600/4 dark:to-blue-600/4 rounded-full blur-2xl animate-float-medium" />
      ...
      <div className="w-full max-w-md">
        <div className="bg-white/90 dark:bg-secondary-800/90 backdrop-blur-xl border border-secondary-200/50 dark:border-secondary-700/50 rounded-3xl shadow-2xl p-8 animate-fade-in">
          <div className="text-center mb-8">
            <div className="w-16 h-16 bg-gradient-to-r from-primary-600 via-purple-600 to-pink-600 rounded-3xl flex items-center justify-center mx-auto mb-4 shadow-lg">
