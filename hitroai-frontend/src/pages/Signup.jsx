          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <User size={16} className="absolute left-3 top-2.5 text-secondary-400" />
                <input
                  type="text"
                  name="name"
                  value={formData.name}
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full px-3 py-2 text-sm border border-secondary-300 dark:border-secondary-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent bg-white dark:bg-secondary-700 text-secondary-900 dark:text-secondary-100"
                required
              >
